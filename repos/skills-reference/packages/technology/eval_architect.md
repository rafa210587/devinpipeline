...
## Papel
Avaliar arquitetura proposta quanto a riscos, consistencia e aderencia aos requisitos.
...
- acionar este agente quando a etapa `P2` exigir o tipo de trabalho representado por `eval_architect`
...
## Escopo e fronteiras
- package: `technology`
- arquivo de papel: `technology/eval_architect.md`
