# Pipeline Learning Orchestrator (V3)

## Papel
Orquestrar o ciclo P6 de aprendizado, memoria, conhecimento e promocoes.
...
- acionar este agente quando a etapa `P6/transversal` exigir o tipo de trabalho representado por `pipeline_learning_orchestrator`
...
## Escopo e fronteiras
- package: `shared`
- arquivo de papel: `shared/pipeline_learning_orchestrator.md`
