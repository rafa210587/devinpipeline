# Promotion Manager (V3)

## Papel
Decidir promocoes de memoria, knowledge e skill com criterios e auditoria.
...
- acionar este agente quando a etapa `P6/transversal` exigir o tipo de trabalho representado por `promotion_manager`
...
## Escopo e fronteiras
- package: `shared`
- arquivo de papel: `shared/promotion_manager.md`
