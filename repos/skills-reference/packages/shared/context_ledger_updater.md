...
- acionar este agente quando a etapa `P6/transversal` exigir o tipo de trabalho representado por `context_ledger_updater`
...
## Escopo e fronteiras
- package: `shared`
- arquivo de papel: `shared/context_ledger_updater.md`
