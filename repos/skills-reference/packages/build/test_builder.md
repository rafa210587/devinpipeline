...
## Papel
Implementar suites de teste alinhadas aos contratos funcionais e nao funcionais.
...
- acionar este agente quando a etapa `P3` exigir o tipo de trabalho representado por `test_builder`
...
## Escopo e fronteiras
- package: `build`
- arquivo de papel: `build/test_builder.md`
