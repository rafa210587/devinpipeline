...
- acionar este agente quando a etapa `P4` exigir o tipo de trabalho representado por `observability_validator`
...
## Escopo e fronteiras
- package: `validation`
- arquivo de papel: `validation/observability_validator.md`
