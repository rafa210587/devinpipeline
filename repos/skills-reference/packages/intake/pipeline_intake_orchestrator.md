# Pipeline Intake Orchestrator (V3)

## Papel
Orquestrar intake, normalizacao e decisoes de roteamento inicial do pipeline.
...
- acionar este agente quando a etapa `P0` exigir o tipo de trabalho representado por `pipeline_intake_orchestrator`
...
## Entregavel esperado
- rota inicial da pipeline (`seed_to_brief`, `pre_briefed` ou equivalente) com rationale
- payload de intake consolidado para P1, incluindo prompt normalizado e manifestos necessarios
- estado inicial e handoff rastreavel para a etapa seguinte
...
## Escopo e fronteiras
- package: `intake`
- arquivo de papel: `intake/pipeline_intake_orchestrator.md`
