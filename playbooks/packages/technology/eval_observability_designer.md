...
- acionar este agente quando a etapa `P2` exigir o tipo de trabalho representado por `eval_observability_designer`
...
## Escopo e fronteiras
- package: `technology`
- arquivo de papel: `technology/eval_observability_designer.md`
