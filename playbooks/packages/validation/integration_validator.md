...
- acionar este agente quando a etapa `P4` exigir o tipo de trabalho representado por `integration_validator`
...
## Escopo e fronteiras
- package: `validation`
- arquivo de papel: `validation/integration_validator.md`
